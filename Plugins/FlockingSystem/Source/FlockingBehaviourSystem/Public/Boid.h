...
UCLASS(BlueprintType, HideCategories = ("Actor", "Cooking", "LOD", "Input", "Pawn", "Camera"))
...
public:
	...
	void AssignMesh(UStaticMesh* NewMesh) const;
	void SetShadowEnabled(bool EnableShadow) const;
	...
	void SetBoids(const TArray<ABoid*>& InBoids);
	#pragma endregion
